...
const aboutSection = () => {
  ...
  textPresentation.innerHTML = `Né de la volonté de révolutionner les espaces de vie et de travail, 
    <a>archi cool</a> incarne une approche fraîche, ludique et colorée de la décoration d’intérieur.</br></br> 
    ...
    Chez <a>archi cool</a>, nous privilégions le choix de matériaux audacieux et vibrants qui subliment les lieux et incitent à la créativité. 
